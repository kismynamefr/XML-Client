import {
    Button, Flex, IconButton, Popover, PopoverArrow, PopoverBody, PopoverContent, PopoverTrigger, Stack, useDisclosure
...
const ButtonOption = ({ getActivatedBot, idBot, botValue }) => {
    ...
    return (
        <>
            {
                isOpen && <Drawers onClose={onClose} isOpen={isOpen} btnRef={btnRef} botValue={botValue}/>
            }
